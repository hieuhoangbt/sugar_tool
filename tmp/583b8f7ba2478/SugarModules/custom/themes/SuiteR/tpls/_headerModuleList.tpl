...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container-fluid">
        ...
        <div class="hidden-xs hidden-sm" id="bs-example-navbar-collapse-1">
            ...
            <div id="business-process-data-top-bar"></div>
            <script id="tpl-business-process-data-top-bar" type="text/template">
                <div class="navbar-form navbar-right">
                    <div class='btn-group btn-defer-right'>
                        <button type='button' class='btn btn-default'>Business process</button>
                        <button type='button' id="autoClickMe" class='btn btn-default dropdown-toggle' data-toggle='dropdown' aria-haspopup='true' aria-expanded='false'>
                            <span class='caret'></span>
                            <span class='sr-only'>Toggle Dropdown</span>
                        </button>
                        <ul class='dropdown-menu' style='width: 400px;'>
                            <li>Task: <a target="_blank" href='%=linkToTask%' style = 'display: inline'>%=Name%</a></li>
                            <li>Relate to: <a target="_blank" href='%=relateToUrl%' style = 'display: inline'>%=parentName%</a></li>
                            <li>Business process name: <a href='javascript:void(0);' style = 'display: inline'>%=businessProcessName%</a></li>
                            <li role="separator" class="divider"></li>
                            %=completionOptions%
                            <li><a href="javascript:void(0);" onClick="window.open('%=urlBusinessProcess%', '', 'toolbar=yes,scrollbars=yes,resizable=yes,top=200,left=500,width=1000,height=1000');" style="display: inline">Display business process</a></li>
            ...
            <script id="tpl-completion-option-business-process" type="text/template">
                <li><a href="javascript:void(0);" class="actionCompletionTop %=disabled-options%" data-userid="%=assigned_user_id%" data-activityid="%=activityID%" data-taskid="%=taskid%" data-completion="%=completion%" style = 'display: inline; %=style-disabled%'>%=completion%</a></li>
            </script>
