...
<link rel="stylesheet" type="text/css" href="custom/themes/SuiteP/css/customCGXStyle.css">
    ...
    <div class="container-fluid">
        ...
        <div class="mobile-bar" id="bs-example-navbar-collapse-1">
            ...
            {* START: Business Process CaseGenix  *}
                <div id="business-process-data-top-bar" class="dropdown nav navbar-nav navbar-right"></div>
                <script id="tpl-business-process-data-top-bar" type="text/template">
                 <a title="Display Bussiness Process" href="javascript:void(0);" id="autoClickMe" class="dropdown-toggle" data-toggle="dropdown"><img src="custom/themes/SuiteP/images/icon_process.png" /></span>
                </a>
                <ul class="dropdown-menu hdropdown animated flipInX businessProcessMenu" role="menu">
                        <li><span>Task:</span> <a target="_blank" href='%=linkToTask%'>%=Name%</a></li>
                        <li><span>Relate to:</span> <a target="_blank" href='%=relateToUrl%'>%=parentName%</a></li>
                        <li><span>Business process name:</span> <a href='javascript:void(0);'>%=businessProcessName%</a></li>
                        <li>%=completionOptions%</li>
                        <li style="cursor:pointer" onClick='window.open("%=urlBusinessProcess%", "", "toolbar=yes,scrollbars=yes,resizable=yes,top=200,left=500,width=1000,height=1000");'>Display business process</li>
                        <li style="cursor:pointer" class="actionDeferTop" data-userid="%=assigned_user_id%" data-activityid="%=activityID%" data-taskid="%=taskid%">Defer</li>
                        %=checkListItems%
                 </ul>
                    
                </script>
                <script id="tpl-completion-option-business-process" type="text/template">
                    <a href="javascript:void(0);" class="actionCompletionTop" data-userid="%=assigned_user_id%" data-activityid="%=activityID%" data-taskid="%=taskid%" data-completion="%=completion%" style="%=style-disabled%">%=completion%</a>
                </script>
