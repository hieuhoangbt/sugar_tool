...
{/php}
		...
		<TR>
<td valign='top' width='25%' align='right'><b>{$MOD.LBL_NAME}:</b></td><td width='75%' colspan='3'>{$ROLE.name}</td>
</tr
><TR>
<td valign='top'  width='25%' align='right'><b>{$MOD.LBL_DESCRIPTION}:</b></td><td colspan='3' valign='top'  width='75%' align='left'>{$ROLE.description | nl2br}</td>
</tr
><TR>
<td valign='top'  width='25%' align='right'><b>{$MOD.LBL_CASEGENIX_ROLE}:</b></td><td colspan='3' valign='top'  width='75%' align='left'>{$ROLE.casegenix_role | nl2br}</td>
</tr></table>
</p>
		<p>
