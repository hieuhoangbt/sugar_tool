...
$invalid_casegenix_role = !empty($_SESSION['invalid-casegenix-role']) ? true : false;
unset($_SESSION['invalid-casegenix-role']);
$sugar_smarty->assign('MSG_ERR_CGX', $invalid_casegenix_role);
