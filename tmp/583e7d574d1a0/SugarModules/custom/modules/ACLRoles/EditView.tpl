...
{*Invalid Casegenix role *}
{if ($MSG_ERR_CGX) }
	<div class="alert-danger " style="padding: 5px 5px 5px 10px; margin-top: 10px;">Invalid Casegenix role</div>
{/if}
...
<tr>
<td scope="row" align='right'>{$MOD.LBL_CASEGENIX_ROLE}:</td>
<td ><textarea name='casegenix_role' cols="80" rows="4">{$ROLE.casegenix_role}</textarea></td>
</tr>
</table>
