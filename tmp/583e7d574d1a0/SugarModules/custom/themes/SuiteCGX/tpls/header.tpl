    ...
    <div class="header">
        ...
        <div class="navbar-right">
            ...
            <script id="tpl-business-process-data-top-bar" type="text/template">
                <a title="Display Bussiness Process" id="autoClickMe" href="javascipt:void(0);" class="dropdown-toggle" data-toggle="dropdown"><img src="themes/SuiteCGX/images/diagram-icon_01.png" /></span>
                </a>
